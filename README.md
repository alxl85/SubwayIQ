...
Pre-Built Modules
- Sales: Sales summaries with daily breakdowns.- 3rd-Party: Third-party sales (DoorDash, GrubHub, etc.) with summaries.- Labor: Employee hours and shifts.- Transactions: Transaction summaries.- Items-Sold: Item sales details.- Discounts: Discount usage summaries.- _CUSTOM: Template for custom modules.
...
Example Output:Sales Report: 2025-07-01 → 2025-07-02
...
Example Output:3rd-Party Sales Report: 2025-07-01 → 2025-07-02
...
Example Output:Labor Hours: 2025-07-01 → 2025-07-01
...
Example Output:Transactions Report: 2025-07-01 → 2025-07-01
...
Example Output:Items-Sold Report: 2025-07-01 → 2025-07-01
All Items Sold
...
Example Output:Discounts: 2025-07-01 → 2025-07-01
BOGO50 (BOGO)
...
Example Output:Custom Report: 2025-07-01 → 2025-07-01
Sample Data Summary
Store  | Value
───────────────────
12345     100
...
Clone the repository:git clone https://github.com/alxl85/SubwayIQ.git
cd SubwayIQ
...
Run the application:python SubwayIQ.py
...
Built for franchisees who want data insights without the hassle.
